...
const AddressCard = ({
  ...
  return <div className={`glass-card p-4 transition-all duration-200 ${onClick ? 'cursor-pointer hover:bg-white/10' : ''}`} onClick={handleCardClick}>
      ...
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            {address.isDefault && <div className="flex items-center gap-1 mt-1">
      ...
      <div className="space-y-1 text-white/80">
        ...
        {address.landmark && <p className="text-sm text-white/60">Near {address.landmark}</p>}
      ...
      {/* Set Default Button */}
      {showActions && !address.isDefault && <Button variant="outline" size="sm" onClick={e => {
      e.stopPropagation();
