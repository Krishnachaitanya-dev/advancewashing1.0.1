...
import { 
  User, Settings, MapPin, CreditCard, 
...
const ProfilePage = () => {
  ...
  return (
    <AppLayout>
          ...
          <div key={section.title}>
            ...
            <div className="glass-card overflow-hidden">
              {section.items.map((item, index) => (
                <div 
                  key={item.id}
                  className={`flex items-center justify-between p-4 text-white hover:bg-white/10 cursor-pointer ${
      ...
      {/* Logout Button */}
      <div className="mt-8">
        <Button variant="outline" className="w-full border-white/20 text-white flex items-center justify-center gap-2">
