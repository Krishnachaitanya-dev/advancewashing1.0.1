  ...
  return (
    <AppLayout>
      ...
      <div className="glass-card p-6 mb-6">
        <h2 className="text-2xl font-bold text-white mb-2">Welcome to Advance Washing</h2>
        <p className="text-white/80 mb-4">Professional laundry service at your doorstep</p>
      ...
      <div className="mb-6">
        <div className="flex justify-between items-center mb-4">
          ...
          <Button variant="ghost" className="text-white flex items-center p-0">
        ...
        <div className="grid grid-cols-2 gap-4">
          {services.map((service) => (
            <div key={service.id} className="glass-card p-4 flex flex-col items-center">
              <div className="bg-blue-900/60 rounded-full p-3 mb-2">
                {service.icon}
              </div>
      ...
      <div className="glass-card p-4">
        ...
        <div className="flex justify-between items-center p-3 bg-white/10 rounded-lg mb-3">
          <div>
            <p className="text-white font-medium">#AW2023154</p>
            <p className="text-white/70 text-sm">Regular Wash · 5 items</p>
          </div>
