  ...
  const orders = [
    {
      ...
      status: 'Delivered',
      items: [
        { name: 'Regular Wash', quantity: '2 kg', price: '₹200' },
        { name: 'Ironing Service', quantity: '5 items', price: '₹300' },
      ],
      total: '₹500',
      trackingSteps: [
        { title: 'Order Confirmed', time: '01 June, 10:00 AM', completed: true },
        { title: 'Picked Up', time: '01 June, 11:30 AM', completed: true },
        { title: 'In Process', time: '01 June, 2:00 PM', completed: true },
        { title: 'Ready for Delivery', time: '02 June, 10:00 AM', completed: true },
        { title: 'Delivered', time: '02 June, 5:30 PM', completed: true }
      ]
    },
    {
      id: 'AWO-1002',
      ...
      status: 'In Progress',
      items: [
        { name: 'Delicate Wash', quantity: '1 kg', price: '₹250' },
        { name: 'Dry Cleaning', quantity: '3 items', price: '₹450' },
      ],
      total: '₹700',
      trackingSteps: [
        { title: 'Order Confirmed', time: '05 June, 9:00 AM', completed: true },
        { title: 'Picked Up', time: '05 June, 12:30 PM', completed: true },
        { title: 'In Process', time: '05 June, 3:00 PM', completed: true },
        { title: 'Ready for Delivery', time: 'Estimated 06 June', completed: false },
          ...
          <div key={order.id} className="glass-card p-4">
            <div className="flex justify-between items-center mb-3">
              ...
              <span className={`text-sm px-2 py-1 rounded-full ${
                order.status === 'Delivered' ? 'bg-green-600/20 text-green-400' : 'bg-yellow-600/20 text-yellow-400'
              }`}>
                {order.status}
              </span>
            </div>
                ...
                {selectedOrder.trackingSteps.map((step: any, index: number) => (
                  <div key={index} className="mb-8 flex">
                    ...
                    {index !== selectedOrder.trackingSteps.length - 1 && (
                      <div className={`absolute h-full w-0.5 left-0 -ml-2 ${
                        step.completed ? 'bg-blue-600' : 'bg-gray-300'
                      }`}></div>
                    )}
                    
                    {/* Circle */}
                    <div className={`-ml-3.5 h-7 w-7 rounded-full border-2 flex items-center justify-center ${
