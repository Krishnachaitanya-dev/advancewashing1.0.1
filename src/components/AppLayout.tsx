  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-500 to-blue-700 relative overflow-hidden">
      ...
      <div className="relative min-h-screen flex flex-col">
        ...
        <header className="p-4 flex items-center justify-between bg-blue-900/30 backdrop-blur-sm border-b border-white/10 safe-area-top">
        ...
        <nav className="fixed bottom-0 left-0 right-0 bg-blue-900/80 backdrop-blur-md border-t border-white/10 safe-area-bottom">
          <div className="flex justify-around max-w-md mx-auto">
            <Link 
              to="/" 
              className={`p-3 sm:p-4 flex flex-col items-center min-h-[60px] ${isActive('/') ? 'text-white' : 'text-white/70'} transition-colors active:scale-95`}
            >
            ...
            <Link 
              to="/services" 
              className={`p-3 sm:p-4 flex flex-col items-center min-h-[60px] ${isActive('/services') ? 'text-white' : 'text-white/70'} transition-colors active:scale-95`}
            >
            ...
            <Link 
              to="/orders" 
              className={`p-3 sm:p-4 flex flex-col items-center min-h-[60px] ${isActive('/orders') ? 'text-white' : 'text-white/70'} transition-colors active:scale-95`}
            >
            ...
            <Link 
              to="/profile" 
              className={`p-3 sm:p-4 flex flex-col items-center min-h-[60px] ${isActive('/profile') ? 'text-white' : 'text-white/70'} transition-colors active:scale-95`}
            >
