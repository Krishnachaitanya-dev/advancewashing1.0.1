...
const AppLayout = memo(({
  ...
  return <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative min-h-screen flex flex-col">
        ...
        <header className="px-3 flex items-center justify-center glass-card mx-3 mt-2 safe-area-top py-[12px] my-[80px]">
          <div className="flex items-center">
            <img src="/lovable-uploads/786946c3-52e3-4da5-b6cf-56e1dae12c59.png" alt="AW Logo" className="w-6 h-6 mr-2" loading="lazy" />
            <h1 className="text-white text-base font-semibold">Advance Washing</h1>
          </div>
        </header>
